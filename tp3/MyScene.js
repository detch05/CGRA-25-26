...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.unitCube = new MyUnitCube(this, 1);
    ...
    initLights() {
        this.setGlobalAmbientLight(this.globalAmbientVar, this.globalAmbientVar, this.globalAmbientVar, 1.0);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(143/255, 72/255, 38/255, 1.0);
        this.material4.setDiffuse(143/255, 72/255, 38/255, 1.0);
